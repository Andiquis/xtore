...
export class Dashboard {
  ...
  kpis = [
    {
      ...
      change: '+12.5%',
      positive: true,
      bgColor: 'linear-gradient(135deg, #4318ff20, #868cff20)',
      color: '#4318ff',
    },
    {
      icon: Package,
      ...
      change: '+8.2%',
      positive: true,
      bgColor: 'linear-gradient(135deg, #05cd9920, #00e4a120)',
      color: '#05cd99',
    },
    {
      icon: Users,
      ...
      change: '+3.1%',
      positive: true,
      bgColor: 'linear-gradient(135deg, #ffb01a20, #ffd76020)',
      color: '#ffb01a',
    },
    {
      icon: BarChart3,
      ...
      change: '-2.4%',
      positive: false,
      bgColor: 'linear-gradient(135deg, #ff5b5b20, #ff8a8a20)',
      color: '#ff5b5b',
    },
  ];
  ...
  recentActivity = [
    {
      ...
      description: 'Pedido #1042 — 3 productos',
      time: 'Hace 5 min',
      bgColor: '#4318ff15',
      color: '#4318ff',
    },
    {
      ...
      description: 'Polo Classic Fit +50 unidades',
      time: 'Hace 22 min',
      bgColor: '#05cd9915',
      color: '#05cd99',
    },
    ...
    },
    {
      icon: AlertTriangle,
      title: 'Stock bajo',
      description: 'Gorra Snapback — quedan 5 uds',
      time: 'Hace 2h',
      bgColor: '#ff5b5b15',
      color: '#ff5b5b',
    },
    {
      ...
      description: 'Pedido #1039 — S/ 450.00',
      time: 'Hace 3h',
      bgColor: '#868cff15',
      color: '#868cff',
    },
  ...
  salesChannels = [
    ...
    },
    {
      ...
      color: '#ffb01a',
      value: 'S/ 1,430',
      iconClass: 'fa-solid fa-boxes-packed',
      bg: 'rgba(255, 176, 26, 0.08)',
    },
  ];
