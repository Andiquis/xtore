...
export class Caja {
  ...
  methodBreakdown = [
    { name: 'Efectivo', value: 2450.4, icon: Banknote, percent: 37, color: '#d97706' },
    { name: 'Tarjeta', value: 3120.8, icon: CreditCard, percent: 47, color: '#4318ff' },
    { name: 'Yape', value: 1020.3, icon: Smartphone, percent: 10, color: '#05cd99' },
    { name: 'Transferencia', value: 450.0, icon: WalletCards, percent: 6, color: '#0ea5e9' },
  ];
  ...
  toggleMovementSelection(movement: any, event: Event) {
    ...
    this.selectedMovements = checked
      ? this.isMovementSelected(movement)
